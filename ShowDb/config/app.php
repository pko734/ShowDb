...
return [
    ...
    */
    ...
    'debug' => @$_SERVER['REMOTE_ADDR'] == '74.111.177.16' ? true : false,
    ...
    */
    ...
    'url' => env('APP_URL', 'https://db.nov.blue'),
    ...
    */
    ...
    'providers' => [
         ...
         */
        ShowDb\Providers\AppServiceProvider::class,
        ShowDb\Providers\AuthServiceProvider::class,
        // ShowDb\Providers\BroadcastServiceProvider::class,
